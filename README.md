...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `81.1µs` | `156.2µs` |
| [Day 2](./src/bin/02.rs) | `68.1µs` | `70.5µs` |
| [Day 3](./src/bin/03.rs) | `1.4ms` | `461.1µs` |
| [Day 4](./src/bin/04.rs) | `174.0µs` | `8.9ms` |
| [Day 5](./src/bin/05.rs) | `22.3µs` | `47.5s` |
